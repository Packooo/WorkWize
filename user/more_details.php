...
<body>
    ...
    <div class="job_listings">
        <div class="job_row">
            <div class="job">
                <a id="back" href="javascript:history.back()" style="float: inline-start;"><i class="fa fa-chevron-left" style="font-size:20px ; "></i></a>
                ...
                <div class="job_details">
                    <div class="details">
                        ...
                        <table>
                            <tr>
                                <td class="subtitle">Jenis pekerjaan</td>
                                <td>
                                    <?php echo $row['jobType']; ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="subtitle">Perusahaan</td>
                                <td>
                            ...
                            <tr>
                                <td class="subtitle">Gajih</td>
                                <td>Rp.
                                    <?php echo $row['price']; ?> per Bulan
                                </td>
                            </tr>
                ...
                <center>
                    <form action="Job_application_form.php" method="get">
                        <button class="apply-btn" type="submit" name="apply">
                            <input type="hidden" name="jobId" value="<?php echo $row['jobId']; ?>">
                            Lamar sekarang! <i class="fas fa-info-circle"></i>
                        </button>
                    </form>
                </center>
