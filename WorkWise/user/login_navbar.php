...
<div class="navbar" id="navbarid">
    ...
    <a class="<?php echo $active2?>" href="user.php" ><i class="fa fa-fw fa-search"></i> Cari Pekerjaan</a>
    <!-- <a class="<?php echo $active3?>" href="find_freelancers.php"><i class="fa fa-group"></i> Find Freelancers</a> -->
    <a class="<?php echo $active4?>" href="save_job.php"><i class="	fa fa-bookmark"></i> Simpan Pekerjaan</a>
    <!-- <a class="<?php echo $active3?>"  href="../user/login_contactus.php"><i class="fa "></i> Kontak Kami</a> -->
    <a class="<?php echo $active5?>" href="../index.php" id="login"><i class="fa fa-sign-out "></i> Log Out</a>
